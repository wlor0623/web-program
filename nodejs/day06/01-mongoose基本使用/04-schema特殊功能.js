...
var heroSchema = mongoose.Schema({
    ...
    versionKey: false,//去掉版本锁 __v0,不建议去掉
    // timestamps: { createdAt: 'a', updatedAt: 'c' }//自动管理修改时间
        //* createAt：默认字段  updateAt:更新时间
    //如果管理时间你不想设置自定义的字段，使用mongoose默认字段
    timestamps:true
});
...
// OldFe.findByIdAndUpdate('5a1690d4e9b873186880bd83',{name:'111111'},function(err){
//     if(err){
//         console.log('老铁插入失败' + fe1);
//         return;
//     }
